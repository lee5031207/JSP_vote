...
<body>
	...
	ArrayList list = voteDAO.getvotedata("student_council");
	Vote votedata = new Vote(); 	
	%>
	<div class="container" style="padding-top: 40px;">
		<div class="col-md-6" style="border-radius: 10px; padding-top: 20px;">
			<form method="POST" action="./vote2.jsp">
				<h2>제 32대 총학생회 선거 투표</h2><br>
				<% 
				...
				<table border="1">
					<tr>
						...
						<td><input type="radio" name="student_council" value=<%=votedata.getNo()%>></td>
					</tr>
				</table><br><br>
				<%} %>
